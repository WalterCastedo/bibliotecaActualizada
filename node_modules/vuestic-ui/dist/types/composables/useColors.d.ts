...
export declare const useColors: () => {
    ...
    currentPresetName: import("vue").ComputedRef<string>;
    ...
    getComputedColor: (color: string) => import("vue").ComputedRef<string>;
    ...
    getTextColor: (color: ColorInput, darkColor?: string | undefined, lightColor?: string | undefined) => string;

export declare const VaButtonToggle: import("vue").DefineComponent<{
    modelValue: {
        type: (StringConstructor | NumberConstructor)[];
        default: string;
    };
    options: {
        type: import("vue").PropType<import("./types").ButtonOption[]>;
        required: true;
    };
    ...
    getButtonProps: (option?: import("./types").ButtonOption) => {

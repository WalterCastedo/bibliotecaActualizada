...
declare const _default: import("vue").DefineComponent<{
    ...
    placement: {
        type: PropType<import("../../composables").Placement>;
        required: true;
        default: import("../../composables").Placement;
    };
    offset: {
        type: PropType<DropdownOffsetProp>;
        required: true;
        default: DropdownOffsetProp;
    };
    keepAnchorWidth: {
        type: PropType<boolean>;
        required: true;
    ...
    trigger: {
        type: PropType<"click" | "hover" | "dblclick" | "none" | "right-click">;
        required: true;
    ...
    datePicker: import("vue").Ref<import("vue").DefineComponent<{
        ...
        syncView: WritableComputedRef<import("../va-date-picker/types").DatePickerView>;
        classComputed: import("vue").ComputedRef<{
            'va-date-picker_without-week-days': boolean;
            'va-date-picker_disabled': boolean;
        }>;
        valueComputed: WritableComputedRef<any>;
    ...
    valueWithoutText: WritableComputedRef<DateInputValue>;
    valueComputed: WritableComputedRef<string | {
        toString: () => string;
        toDateString: () => string;
        toTimeString: () => string;
        toLocaleString: {
    ...
    isOpenSync: WritableComputedRef<boolean | undefined>;
    ...
    dropdownPropsComputed: import("vue").ComputedRef<{
        ...
        readonly: boolean;
        disabled: boolean;
        placement: import("../../composables").Placement;

...
export declare const VaSelect: import("vue").DefineComponent<{
    ...
    rules: {
        ...
        type: import("vue").PropType<((v: import("./types").SelectOption) => any)[]>;
    };
    success: {
        type: BooleanConstructor;
        default: boolean;
    ...
    textBy: {
        type: import("vue").PropType<string | ((option: import("./types").SelectOption) => unknown)>;
        default: string;
    };
    valueBy: {
        type: import("vue").PropType<string | ((option: import("./types").SelectOption) => unknown)>;
    ...
    optionList: import("vue").ShallowRef<import("vue").DefineComponent<{
        ...
        virtualScrollerRef: import("vue").ShallowRef<({
            ...
            } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "table" | "horizontal" | "disabled" | "trackBy" | "items" | "bench" | "itemSize" | "wrapperSize">;
            $attrs: {
                [x: string]: unknown;
            };
            $refs: {
        ...
        optionGroups: import("vue").ComputedRef<Record<string, import("./types").SelectOption[]>>;
        filteredOptions: import("vue").ComputedRef<import("./types").SelectOption[]>;
        selectOptionProps: import("vue").ComputedRef<{
            getText: (option: import("./types").SelectOption) => any;
            getTrackBy: (option: import("./types").SelectOption) => any;
            color: string;
            getSelectedState: (option: import("./types").SelectOption) => boolean;
        }>;
        isSlotContentPassed: import("vue").ComputedRef<boolean>;
        ...
        getDisabled: (option: import("./types").SelectOption) => any;
        selectOption: (option: import("./types").SelectOption) => false | void;
        ...
        textBy: string | ((option: import("./types").SelectOption) => unknown);
        valueBy: string | ((option: import("./types").SelectOption) => unknown);
        trackBy: string | ((option: import("./types").SelectOption) => unknown);
        disabledBy: string | ((option: import("./types").SelectOption) => unknown);
        groupBy: string | ((option: import("./types").SelectOption) => unknown);
        multiple: boolean;
    ...
    tabIndexComputed: import("vue").ComputedRef<number>;
    valueComputed: import("vue").WritableComputedRef<import("./types").SelectOption | import("./types").SelectOption[]>;
    ...
    computedError: import("vue").WritableComputedRef<boolean>;
    filteredOptions: import("vue").ComputedRef<import("./types").SelectOption[]>;
    checkIsOptionSelected: (option: import("./types").SelectOption) => boolean;
    ...
    errorMessages: string | string[];
    errorCount: string | number;
    rules: ((v: import("./types").SelectOption) => any)[];
    messages: string | string[];
    immediateValidation: boolean;
    loading: boolean;
    options: import("./types").SelectOption[];

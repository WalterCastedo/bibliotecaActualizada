export declare const VaSelectOptionList: import("vue").DefineComponent<{
    ...
    textBy: {
        type: import("vue").PropType<string | ((option: import("../..").SelectOption) => unknown)>;
        default: string;
    };
    valueBy: {
        type: import("vue").PropType<string | ((option: import("../..").SelectOption) => unknown)>;
    ...
    selectOptionProps: import("vue").ComputedRef<{
        getText: (option: import("../..").SelectOption) => any;
        getTrackBy: (option: import("../..").SelectOption) => any;
        color: string;
        getSelectedState: (option: import("../..").SelectOption) => boolean;
    }>;
    isSlotContentPassed: import("vue").ComputedRef<boolean>;
    currentOptionComputed: import("vue").ComputedRef<import("../..").SelectOption | null>;
    onScroll: (event: UIEvent) => void;
    getTrackBy: (option: import("../..").SelectOption) => any;
    setItemRef: (key: string | number) => (el: any) => string | undefined;
    getDisabled: (option: import("../..").SelectOption) => any;
    selectOption: (option: import("../..").SelectOption) => false | void;
    ...
    textBy: string | ((option: import("../..").SelectOption) => unknown);
    valueBy: string | ((option: import("../..").SelectOption) => unknown);
    trackBy: string | ((option: import("../..").SelectOption) => unknown);
    disabledBy: string | ((option: import("../..").SelectOption) => unknown);
    groupBy: string | ((option: import("../..").SelectOption) => unknown);
    multiple: boolean;

...
const _sfc_main = defineComponent({
  ...
  setup(props) {
    ...
    const classComputed = useBem("va-card", () => ({
      ...pick_1(props, ["square", "outlined", "disabled"]),
...
export { _VaCard as _ };
//# sourceMappingURL=VaCard.mjs.map

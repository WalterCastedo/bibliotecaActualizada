...
import { V as VaModal } from "../va-modal/VaModal.mjs";
...
import { V as VaFileUploadList } from "./VaFileUploadList/index.mjs";
  ...
  return openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      createElementVNode("div", _hoisted_1, [
        _ctx.dropzone ? (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(_ctx.tp(_ctx.dropZoneText)), 1)) : createCommentVNode("", true),

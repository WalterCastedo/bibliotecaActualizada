...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/waltercastedosaucedo/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20c0b973246207a73a90f2Vh5VDRkDCAEGClUEA1IKA1wCA1MA', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/waltercastedosaucedo/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20c0b973246207a73a90f2Vh5VDRkDCAEGClUEA1IKA1wCA1MA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
